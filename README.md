...
docs at https://crossplane.workshops.riccardocapraro.it/solo-local-setup (plain `kubectl apply -f`
...
| What | URL |
|------|-----|
| Docs site | https://crossplane.workshops.riccardocapraro.it/ |
| Wall (all tiles) | https://crossplane.workshops.riccardocapraro.it/wall |
| vCluster Platform | https://platform-crossplane.workshops.riccardocapraro.it/ |
