...
<ThemedImage
  alt="A Provider spawns a Pod, a ProviderConfig points the Pod at a Secret, and a Managed Resource references the ProviderConfig. The Pod watches the MR and calls the External API."
  sources={{
...
- [(Guided) Create resources in GitHub](../crossplane-3xx/provider-github)
- [Create resources in AWS](../crossplane-3xx/provider-aws)
- [Create resources in GCP](../crossplane-3xx/provider-gcp)
- [Create resources in Azure](../crossplane-3xx/provider-azure)
- [(Guided) Create resources in Aruba](../crossplane-3xx/provider-arubacloud)
