...
Skip section 2.1 — you're already on the right cluster. Everywhere this module says
"inside your vcluster", read "in your k3d cluster". See
[Solo local setup (k3d)](./05-solo-local-setup).
:::
