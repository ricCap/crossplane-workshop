...
- [provider-github contro un'org reale](../crossplane-3xx/provider-github)
- [provider-aws contro il tuo account AWS](../crossplane-3xx/provider-aws)
- [provider-gcp contro il tuo progetto Google Cloud](../crossplane-3xx/provider-gcp)
- [provider-azure contro la tua subscription Azure](../crossplane-3xx/provider-azure)
