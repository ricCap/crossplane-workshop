...
# Benvenuti al workshop di Crossplane ⏱️ 8m
...
|---|---|---|---|
| | Introduzione | contenuto | 8m |
| | Cheatsheet | riferimento | — |
| | Connetti il tuo cluster | task | 18m |
| Crossplane 101 | Installa Crossplane | task | 20m |
| Crossplane 101 | La tua prima Composition | task | 22m |
| Crossplane 101 | Definisci un'Application | task | 35m |
| Crossplane 101 | Modifica la tua Application | task | 22m |
| Crossplane 101 | Aggiungi un Provider | task | 25m |
| | Conclusioni | contenuto | 7m |
