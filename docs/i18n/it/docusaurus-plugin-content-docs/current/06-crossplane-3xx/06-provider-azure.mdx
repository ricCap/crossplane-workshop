---
sidebar_position: 6
title: provider-azure sulla tua sottoscrizione Azure
translation_source_commit: f9facfcfeafd8b3228c39798c22778f99f53aa70
---

import PairId from '@site/src/components/PairId';
import ValidateCheck from '@site/src/components/ValidateCheck';

# provider-azure sulla tua sottoscrizione Azure ⏱️ 35m
...
- **Componi attorno.** Avvolgi `Account` (e i suoi fratelli `Container`, `Blob`, `ManagementPolicy`) in un XR come `XBucket` così gli utenti della piattaforma ottengono un account opinionated, encrypted, lifecycle-managed da una sola riga di YAML — stessa forma dell'[`XApplication`](../crossplane-101/define-application) che hai scritto nel modulo 4 del 101.
