...
translation_source_commit: 335f560795acfd54c901304c890f83905eb92749
---
...
Il tuo istruttore ti ha dato un link per scaricare il kubeconfig della tua coppia. Scarica il file e tieni a portata il percorso — questo esempio assume `~/Downloads/<pair-id>-kubeconfig.yaml`.

### 2. Punta la tua shell al file
...
Il comando `current-context` stampa il nome del context — considera qualsiasi output non vuoto come successo. Se `kubectl` stampa un errore, ricontrolla il percorso del file e che il download sia andato a buon fine.

### 3. Elenca i namespace come smoke test
...
### 4. (Opzionale) Installa qualche tool comodo
