...
- **Central UI**: vCluster Platform on the management cluster, exposed at `https://platform-crossplane.workshop.riccardocapraro.com`. Participants log in with the per-pair credentials the Composition generates.
