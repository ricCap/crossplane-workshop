...
- **Central UI**: vCluster Platform on the management cluster, exposed at `https://platform.testdomain-riccap.it`. Participants log in with the per-pair credentials the Composition generates.
